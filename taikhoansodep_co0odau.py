    ...
    for j in range (0, 10):
        for k in range (0,10):
            for l in range (0,10):
                for m in range (0,10):
                    for i in range (0,10):
                        if j!=k and l!=m and not (j==6 and k==8) and not (j==6 and k==6) and  not (j==8 and k==6) and not (j==8 and k==8) and not (l==6 and m==8) and not (l==6 and m==8) and not (l==8 and m==6) and not(l==8 and m==8) and not (j==m and k==l):
                            print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,j,k,l,m,i,i,i,i,i,i))
                        if i!=j and j!=k and l!=m and not (j==6 and k==8) and not (j==6 and k==6) and  not (j==8 and k==6) and not (j==8 and k==8) and not (l==6 and m==8) and not (l==6 and m==8) and not (l==8 and m==6) and not(l==8 and m==8) and not (j==m and k==l):
...
def NguQuyTamHoaLap(format="BBCCCAAAAA"):#complete
    ...
    for j in range (0, 10):
        for k in range (0,10):
            for i in range (0,10):
                if j!=k and k!=i and not (j==6 or j==8 or k==6 or k==8):
                ...
                if i!=j and j!=k and not (j==6 or j==8 or k==6 or k==8):
...
def TuQuyLapDoi(format="BBBBCCAAAA"):#complete
    #BBBBCDAAAA
    #BDCCCCAAAA
    #AAAABBBBCD
    for j in range (0, 10):
        for k in range (0,10):
            for l in range (0,10):
                for i in range (0,10):
                    if j != l and i!=k :
                        print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,j,j,j,j,l,i,k,k,k,k))
                    if i!=j and j!=k :
                        print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,l,i,j,j,j,j,k,k,k,k))
                    if j!=k and k!=l :
                        print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,j,j,j,j,k,k,k,k,l,i))
...
def TienLap4(format="ABCDABCDEF"):#complete
    #ABCDABCDEF
    #EFABCDABCD
    for j in range (0, 10):
        for k in range (0,10):
            for i in range (0,10):
                if j+3<10 and j+3!=k:
                    print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,j,j+1,j+2,j+3,j,j+1,j+2,j+3,k,i))
                if j+3<10 and i!=j:
                    print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,k,i,j,j+1,j+2,j+3,j,j+1,j+2,j+3))

def TienLap5(format="ABCDEABCDE"):#complete
    #ABCDABCDEF
    #EFABCDABCD
    for j in range (0, 10):
        if j+4<10:
            print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,j,j+1,j+2,j+3,j+4,j,j+1,j+2,j+3,j+4))

def SoGanh5(format="ABCDEEDCBA"):#complete
    for j in range (0, 10):
        if j+5<10:
            print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,j,j+1,j+2,j+3,j+4,j+4,j+3,j+2,j+1,j))

def SoGanh4SongHy(format="ABCDFGDCBA"):#complete
    for j in range (0, 10):
        for k in range (0,10):
            if j+4<10 and j!=k and k!=j+4:
                print("%s,%s,%d%d%d%d%d%d%d%d%d%d" %(str(sys._getframe().f_code.co_name),format,j,j+1,j+2,j+3,k,k,j+3,j+2,j+1,j))
